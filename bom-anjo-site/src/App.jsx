...
export default function App() {
  const planos = [
    {
      ...
      dia: "R$ 3,66 por dia",
      descricao:
        "Plano mais completo, com cobertura familiar e assistência premium.",
      beneficios: [
...

    {
      ...
      dia: "R$ 2,16 por dia",
      descricao:
        "Plano familiar com excelente equilíbrio entre cobertura e valor.",
      beneficios: [
        "Titular, cônjuge, filhos, pai e mãe, sogro e sogra",
        "Urna sextavada com visor, verniz brilho e alça-varão",
        "Bíblia ou crucifixo na tampa",
...

    {
      ...
      dia: "R$ 1,83 por dia",
      descricao:
        "Plano acessível para proteger sua família com segurança.",
      beneficios: [
        "Titular, cônjuge, filhos, pai e mãe, sogro e sogra",
        "Urna sextavada com visor, verniz brilho e alça-varão",
        "Inclui assepsia",
...

    {
      ...
      dia: "R$ 1,50 por dia",
      descricao:
        "Plano de entrada para quem busca proteção familiar essencial.",
      beneficios: [
        "Titular, cônjuge, filhos, pai e mãe, sogro e sogra",
  ...
  const parceiros = [
    ...
    {
      nome: "Farmácia Cerro Azul",
      imagem: fcerro,
      categoria: "Farmácia",
    },

    {
      nome: "Dra. Kamila Souza",
      imagem: kamila,
    ...
    <div className="site">
      <header className="header">
        <a href="#inicio" className="brand">
          <img
            src={logoBomAnjo}
            alt="Bom Anjo Assistência Funerária"
          />
        ...
        <button
          ...
          onClick={() =>
            abrirWhatsApp(
              "Olá, vim pelo site da Bom Anjo e gostaria de atendimento."
            )
          }
        >
          Atendimento
      ...
      <main>
        <section id="inicio" className="hero">
          ...
          <div className="heroText">
            <span className="tag">
              Desde 2001 • Plano Funeral Familiar
            </span>

            <h1>
              Proteção, amparo e tranquilidade para sua família.
            </h1>

            <p>
              Planos funerários familiares com cobertura completa,
              atendimento humanizado e benefícios exclusivos para
              associados Bom Anjo.
            </p>
          ...
          <div className="heroCard">
            ...
            <button
              onClick={() =>
                abrirWhatsApp(
                  "Olá, quero saber mais sobre os planos da Bom Anjo."
                )
              }
            >
              Falar no WhatsApp
        ...
        <section id="planos" className="plansSection">
          <span className="tag">
            Planos de Assistência Funeral Familiar
          </span>

          <h2>
            Escolha o plano ideal para proteger quem você ama
          </h2>
        ...
        <section id="clube" className="clubSection">
          ...
          <p className="clubText">
            Sendo associado Bom Anjo, você participa
            de um grupo especial de descontos com
            empresas parceiras da nossa cidade.
          </p>
            ...
            {parceiros.map((parceiro) => (
              ...
              >
                ...
                <div>
                  ...
                  <p>
                    Desconto especial para Bom Anjo.
                  </p>
                  ...
                  <button
                    ...
                    onClick={() =>
                      abrirWhatsApp(
                        `Olá, sou associado Bom Anjo e gostaria de saber mais sobre o desconto no parceiro ${parceiro.nome}.`
                      )
                    }
                  >
                    Consultar desconto
          ...
          <button
            onClick={() =>
              abrirWhatsApp(
                "Olá, sou associado Bom Anjo e gostaria de saber mais sobre o Clube de Descontos."
              )
            }
          >
        ...
        >
          ...
          <h2>
            Assistência completa para momentos delicados
          </h2>
          ...
          <div className="benefitsGrid">
            <div>
              ...
              <p>
                Urna sextavada com visor, verniz brilho
                e acabamento conforme o plano escolhido.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Cobertura para Cerro Azul, Doutor
                Ulysses, Curitiba e região
                metropolitana.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Ornamentação, coroa de flores e faixa
                de homenagem personalizada.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paramentação conforme religião, livro
                de presença e kit café.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Titular, cônjuge, filhos, pai e mãe,
                sogro e sogra.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Equipe preparada para orientar sua
                família com respeito e discrição.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="contato" className="contact">
          ...
          <p>
            Cuidado, respeito e amparo para sua
            família.
          </p>
      ...
      <footer>
        © 2026 Bom Anjo Assistência Funerária.
